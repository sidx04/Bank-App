...
const FeedbackCard = ({content,name,title,img}) => {
  return (
    ...
    md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
      ...
      <p className="font-poppins font-normal  text-[18px] leading-[32px] text-indigo-100 my-10">{content}</p>
      ...
      <div className="flex flex-row">
        ...
        <div className="flex flex-col ml-4 ">
          ...
          <p className="font-signika font-normal mt-[-2px] text-[16px] leading-[24px] text-indigo-100">{title}</p>
        </div>
      </div>
    </div>
  )
